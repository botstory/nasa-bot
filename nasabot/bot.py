    ...
    def init(self, auto_start, fake_http_session):
        self.story.use(fb.FBInterface(
            ...
            greeting_text='Hello dear {{user_first_name}}!\n'
                          'I\'m NASA bot based on BotStory framework.\n'
                          'and I\'m here to help you to sort out with NASA data.',
                    ...
                    'call_to_actions': [
                        {
                            'type': 'web_url',
                            'title': 'Source Code',
                            'url': 'https://github.com/botstory/nasa-bot/',
                        }, {
                            'type': 'postback',
                            'title': 'About',
                            'payload': 'ABOUT_ME',
        ...
        db = self.story.use(mongodb.MongodbInterface(
            ...
            db_name=os.environ.get('MONGODB_DB_NAME', 'nasabot'),
        ))
